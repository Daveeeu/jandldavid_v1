...
const FAQS = [
  {
    ...
    a: "A projekt méretétől és összetettségétől függően általában 1–6 hét között. Nagyobb rendszereknél először részletes technikai felmérés készül.",
  },
  {
    q: "Csak weboldalakat készítesz?",
    a: "Nem. Landing oldalak mellett backend rendszerekkel, API fejlesztéssel, infrastruktúrával, deploymenttel és security-first fejlesztéssel is foglalkozom.",
  },
  {
    q: "Tudsz segíteni meglévő rendszerek továbbfejlesztésében?",
    a: "Igen. Sok esetben nem új rendszer építése a cél, hanem meglévő projektek stabilizálása, optimalizálása vagy modernizálása.",
  },
  {
    q: "Van support és hosszú távú támogatás?",
    a: "Igen. Monitoring, karbantartás, biztonsági frissítések és további fejlesztési támogatás is elérhető.",
  },
  {
    q: "Hogyan indul el a közös munka?",
    a: "Leírod röviden az ötletedet vagy problémádat, ezután pontosítjuk az igényeket és meghatározzuk a legjobb technikai irányt.",
  },
  {
    q: "Milyen technológiákkal dolgozol?",
    a: "Laravel, Vue, React, Docker, Linux, API rendszerek, cloud infrastruktúrák és modern webes technológiák.",
  },
  {
    q: "Nemzetközi projekteket is vállalsz?",
    a: "Igen. Magyar és nemzetközi ügyfelekkel is szívesen dolgozom.",
  },
];
